	...
	describe('Sync Methods', function() {
		...
		describe('Name', function() {
			it('names the span as Class.Method by default', function() {
				...
				expect(startSpanStub).to.be.calledWith(`${spanTestClassName}.doTheThingSpanned`);
			});
		...
		describe('Type', function() {
			it('uses the class name as the type by default', function() {
				...
				expect(startSpanStub).to.be.calledWith(sinon.match.any, spanTestClassName);
			});
			...
			it('overrides the type when set by config', function() {
				...
				expect(startSpanStub).to.be.calledWith(sinon.match.any, overriddenType);
			});
		});
	});
	...
	describe('Async Methods', function() {
		...
		describe('Name', function() {
			it('names the span as Class.Method by default', async function() {
				...
				expect(startSpanStub).to.be.calledWith(`${spanTestClassName}.doTheThingSpannedAsync`);
			});
